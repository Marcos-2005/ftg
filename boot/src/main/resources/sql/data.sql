...
INSERT INTO dispositivo (type, brand, model, serial_number, description, image_url, client_id) VALUES
...
INSERT INTO tecnicos (name, assigned_orders_count, active) VALUES
('Carlos Méndez', 2, TRUE),
('Lucía Torres', 1, TRUE),
('Pedro Salas', 1, TRUE);

INSERT INTO empresa (name, address, phone, email, iva_rate, welcome_message, completion_message, admin_id) VALUES
...
INSERT INTO ordenes_servicios (entry_date, status, difficulty, cost, device_id, technician_id) VALUES
...
INSERT INTO diagnosticos (service_order_id, description, final_cost, technician_id) VALUES
...
INSERT INTO citas (client_id, technician_id, scheduled_at, description) VALUES
...
INSERT INTO administradores_clientes (administrator_id, client_id) VALUES
(1, 1),
(2, 2),
(1, 2);
